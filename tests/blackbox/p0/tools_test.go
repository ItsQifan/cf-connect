...
// TestP0_14_ToolInvocation_ClaudeCode verifies that cf-connect routes a task
...
// TestP0_15_LongResponse_ClaudeCode verifies that cf-connect correctly handles
