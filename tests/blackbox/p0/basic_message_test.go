...
// user sends a message → cf-connect routes it to Claude Code → user receives
// a non-empty reply.
//
...
// cf-connect sends a confirmation message.
...
// TestP0_5_StopCurrentTask_ClaudeCode verifies /stop causes cf-connect to
