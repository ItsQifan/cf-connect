...
// service. Tests inject messages via InjectMessage and verify cf-connect's
...
// SentMessage captures a single outbound call from cf-connect to the platform.
...
// InjectMessage simulates a user sending a plain-text message to cf-connect.
...
// turn when cf-connect may send multiple messages per turn (thinking indicators,
