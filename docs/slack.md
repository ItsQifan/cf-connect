...
This guide walks you through connecting **cf-connect** to Slack, so you can chat with your local Claude Code via a Slack bot.
...
| Field | Suggested Value |
|-------|----------------|
| Display Name (Bot Name) | `cf-connect` |
...
1. Enter a token name (e.g. `cf-connect-socket-token`)
