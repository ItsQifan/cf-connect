...
**Goal:** Enable a single cf-connect bot to serve multiple workspaces, routing messages to different Claude Code sessions based on Slack channel.
...
**Files:**
- Modify: `cmd/cf-connect/main.go` (~line 139 project setup loop)
...
```bash
git add cmd/cf-connect/main.go
