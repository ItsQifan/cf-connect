...
func DefaultLogFile() string {
	...
	return filepath.Join(home, ".cf-connect", "logs", "cf-connect.log")
}
...
// ── Metadata ────────────────────────────────────────────────
// Stored at ~/.cf-connect/daemon.json so that `logs`, `status`,
...
// env. cf-connect resolves these placeholders at startup using os.ExpandEnv;
