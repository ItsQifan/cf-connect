...
//
// Full inventory: projects/cf-connect/agents/qa-cursor/release-gate/CUJ-INVENTORY.md
package core
...
// ===========================================================================
// CUJ-D7 · outgoing_rate_limit throttles bursts so cf-connect does not get
...
// ===========================================================================
// CUJ-B12 · After cf-connect restarts, the user's session, history, agent
...
func TestCUJ_D6_InboundRateLimitDrops(t *testing.T) {
	...
	// (or 1 if cf-connect reuses session per burst).
	if n > 2 {
...
// CUJ-H1 · Two projects in one cf-connect: sessions/messages do not cross
